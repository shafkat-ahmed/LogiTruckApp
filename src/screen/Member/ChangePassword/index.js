      ...
      <Container style={theme.layoutFx}>
        ...
        <Content contentContainerStyle={theme.layout}>
          ...
          <View style={styles.formContainer}>
            <View style={styles.formHeader}>
              <Icon name='lock' type='SimpleLineIcons' style={styles.formHeaderIcon} />
              <View style={styles.formHeaderCol}>
                <Text style={styles.formHeaderTitle}>{__('Change Password')}</Text>
                <Text style={styles.formHeaderDesc}>{__('Change your password')}</Text>
              </View>
            </View>
        ...
        <Modal
          ...
          <ScrollView contentContainerStyle={styles.modalContent}>
            ...
            <Text style={styles.modalContentDesc}>{__('Your password has been change successfully')}</Text>
          </ScrollView>
        </Modal>
      </Container>
    )
